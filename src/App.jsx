      ...
      >
        <label className="font-semibold text-2xl">
          ...
          <input
            ...
            className="border-[1px] mt-6 pl-4 ml-7 border-zinc-400"
            placeholder="Enter............."
            value={newTask}
          />
          <br />
          <input
            type="submit"
            value="Add Task"
            className="bg-green-400 mt-4 text-md rounded-2xl font-semibold px-4 py-2"
          />
        </label>
      </form>
      <p className="text-2xl font-bold text-center mt-4 mb-3">
            ...
            {tasks.map((item, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-red-500 mr-4 px-4 py-2 font-semibold text-xs rounded-md"
                >
                  Delete
                </button>
              </div>
